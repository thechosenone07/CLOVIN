...
**If you need any more modes in repo or If you find out any bugs, mention in [CLOVIN](https://github.com/thechosenone07/CLOVIN)
...
#### Deploy in your VPS
````bash
git clone https://github.com/thechosenone07/CLOVIN
cd File-Sharing-Bot
...
## Support   
👽 [ MAN ](https://t.me/J_A_R_V_l_S) For Support/Assistance And Our [Channel](https://www.telegram.dog/codexbotz) For Updates.   
